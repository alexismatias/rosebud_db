class ReflectionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @reflection.save
        format.html { redirect_to reflection_url(@reflection), notice: "Reflection was successfully created." }
  ...
  def update
    respond_to do |format|
      if @reflection.update(reflection_params)
        format.html { redirect_to reflection_url(@reflection), notice: "Reflection was successfully updated." }
  ...
  private
    ...
    def reflection_params
      params.require(:reflection).permit(:item, :cost, :expense_category, :emotion, :comment)
    end
end
